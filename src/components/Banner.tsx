...
const Banner = () => {
    return (
        <section id='home' className='pt-48 relative h-[100vh] md:h-[140vh]' >
            <div className='absolute bg-bannerImg md:bg-contain bg-cover w-full h-full opacity-30 md:opacity-100 bg-right bg-no-repeat md:-top-4 -top-20 md:right-20'></div>
