...
const Freelancing = () => {
    return (
        <section id="freelancing" className="bg-fixed relative py-10 md:h-[90vh] bg-[url('/bg_freelancing.jpg')] bg-cover bg-center my-20 flex flex-col items-center justify-center">
            <Numbers />
            <div className='mt-10 md:mt-0 max-w-[92%] mx-auto text-center'>
                <h2 className='text-3xl md:text-5xl font-semibold'>I am <span className='text-yellow-500'>Available</span> for freelancing</h2>
